...
def get_pipeline():
    ...
    pipe.load_lora_weights("backend/models/narrator_lora.safetensors", adapter_name="narrator")
    pipe.load_lora_weights("backend/models/worker_lora.safetensors", adapter_name="worker")
